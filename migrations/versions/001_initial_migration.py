...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('OPEN', 'MERGED', name='prstatus'), nullable=False, server_default='OPEN'),
        sa.Column('assigned_reviewers', postgresql.JSON(astext_type=sa.Text()), nullable=False, server_default='[]'),
